  ...
  domString += `
    <div class="mt-5 d-flex flex-wrap">
      <div class="d-flex flex-column">
        <img src=${obj.bookObject.values().image} alt=${obj.bookObject.title} style="width: 300px;">
        <div class="mt-5">
        ...
        <div class="text-white ms-5 details">
        <h5>${obj.bookObject.title} by ${obj.first_name} ${obj.last_name} ${obj.favorite ? '<span class="badge bg-danger"><i class="fa fa-heart" aria-hidden="true"></i></span>' : ''}</h5>
        Author Email: <a href="mailto:${obj.email}">${obj.email}</a>
